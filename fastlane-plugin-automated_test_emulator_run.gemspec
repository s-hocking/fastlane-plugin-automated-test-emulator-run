...
Gem::Specification.new do |spec|
  spec.name          = 'fastlane-plugin-automated_test_emulator_run_shocking'
  spec.version       = Fastlane::AutomatedTestEmulatorRunShocking::VERSION
  ...
  spec.homepage      = "https://github.com/s-hocking/fastlane-plugin-automated-test-emulator-run"
  spec.license       = "MIT"
